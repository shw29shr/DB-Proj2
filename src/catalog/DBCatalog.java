...
public class DBCatalog {
	...
	public static BufferedReader createTableBuffer(String fileName) {
		fileName = (aliases.containsKey(fileName))?aliases.get(fileName):fileName.trim();
		try {
			String actualTableName = (aliases.containsKey(fileName))?aliases.get(fileName):fileName.trim();
			return new BufferedReader(new FileReader(dataDirectory + actualTableName));
